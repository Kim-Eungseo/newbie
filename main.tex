...
\begin{frame}[plain]
  \begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.9\textheight,keepaspectratio]{images/parallelism.png}
  \end{figure}
\end{frame}
...
\begin{frame}[plain]
  \begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth,height=0.9\textheight,keepaspectratio]{images/temperature.png}
    \caption*{\textbf{Temperature Visualization}: How temperature affects token probability distribution}
  \end{figure}
\end{frame}
